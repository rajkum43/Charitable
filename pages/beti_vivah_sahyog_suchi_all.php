<?php
/**
 * Beti Vivah Sahyog Suchi - All Donations
 * Displays all Beti Vivah donations with filters
 */
...
<head>
    ...
    <title>बेटी विवाह सहयोग सूची - BRCT Bharat Trust</title>
...
<body>
    ...
    <section class="members-header">
        <div class="container">
            <div class="members-header-content">
                <h1>
                    <i class="fas fa-gift me-3"></i>बेटी विवाह सहयोग सूची
                </h1>
                <p>सभी बेटी विवाह सहायता दान की सूची और विवरण</p>
            </div>
        </div>
    </section>
    ...
    <!-- Sahyog Suchi JS -->
    <script src="../assets/js/sahyog-suchi.js"></script>
</body>
</html>
