...
// Get all distinct alerts from poll table for Death applications
try {
    ...
    error_log('Error fetching death alerts: ' . $e->getMessage());
    $alerts = [];
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>सूचना मृत्यु सहयोग सूची - BRCT Bharat Trust</title>
    ...
    <!-- Alert Death Sahyog Suchi CSS -->
    <link rel="stylesheet" href="../assets/css/alert-death-suchi.css">
...
<body data-base-path="<?php echo $root_path; ?>">
    ...
    <section class="members-header bg-primary text-white p-2">
        <div class="container">
            <div class="members-header-content">
                <h1>
                    <i class="fas fa-bell me-3"></i>सूचना मृत्यु सहयोग सूची
                </h1>
                <p>प्रकाशित सूचियों के अनुसार मृत्यु सहायता विवरण</p>
            </div>
        </div>
    </section>
        ...
        <div class="container alerts-container">
                ...
                <div class="alerts-list">
                    <?php foreach ($alerts as $alert): ?>
                        ...
                        <div class="alert-card">
                            ...
                            <a href="alert_details_death_sahyogsuchi.php?alert=<?php echo htmlspecialchars($alert); ?>" 
            ...
            <?php else: ?>
                <div class="no-alerts">
                    ...
                    <p class="text-muted">अभी तक कोई मृत्यु सहायता प्रकाशित नहीं की गई है।</p>
                </div>
            <?php endif; ?>
    ...
    <!-- Alert Death Sahyog Suchi JS -->
    <script src="../assets/js/alert-death-suchi.js"></script>
</body>
</html>